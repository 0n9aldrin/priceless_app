...
import 'package:priceless/stocks/models/profile/news/stock_news.dart';
...
class ProfileNewsScreen extends StatelessWidget {
  ...
  ProfileNewsScreen({@required this.news});
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            singleNew.source,
            style: TextStyle(color: kLighterGray, fontWeight: FontWeight.w600),
          ),
          SizedBox(height: 8),
          Text(
            singleNew.headline,
