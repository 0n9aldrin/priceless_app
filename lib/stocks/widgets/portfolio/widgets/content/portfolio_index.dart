...
class PortfolioIndexWidget extends StatelessWidget {
  ...
  PortfolioIndexWidget({@required this.index});

  static const _indexNameStyle =
      const TextStyle(fontWeight: FontWeight.bold, fontSize: 16);

  static const _indexPriceStyle =
      const TextStyle(fontSize: 14, color: kLightGray);
        ...
        child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  determineTextBasedOnChange(index.change),
                  style: _indexPriceChange,
                ),
              ),
            ]),
      ),
